...
template void disentangled_kernel_wrapper_v2<float, 32, 8>( float const *, float const *, float const *,  float *, dim3 , dim3 , dim3 , dim3 , float, int , dim3 , dim3 , cudaStream_t );
...
template void disentangled_kernel_wrapper_v2<int8_t, 32, 8>( int8_t const *, int8_t const *, int8_t const *,  int8_t *, dim3 , dim3 , dim3 , dim3 , int8_t, int , dim3 , dim3 , cudaStream_t );
